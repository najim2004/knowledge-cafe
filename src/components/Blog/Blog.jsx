        ...
        <div>
            ...
            <div className='flex justify-between mt-8'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <button onClick={()=>handleBookmarks(blog)}><img className='size-6' src={vector} alt="" /></button>
                </div>
            </div>
            ...
            <button onClick={()=>handleReadingTime(id,reading_time)} className='mt-5 text-xl font-semibold underline text-[#6047EC]'>Mark as read</button>
